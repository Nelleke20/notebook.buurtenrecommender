...
class BuurtenModel(rules.BusinessRulesOne, rules.BusinessRulesTwo):
    ...
    def apply_business_rules_two(self, X, output_one):
        # business-rules.py  is used to define business rules
        return super().apply_business_rules_two(X, output_one)

    def apply_model_one(self, X):
    ...
    def predict(self, X):
        ...
        output_step_one["prediction_one"] = [
            ...
            else self.apply_model_one(X_prep)
        ]
        ...
        output_step_two["prediction_two"] = [
            ...
            else self.apply_model_two(X_prep)
        ][0]
